...
const walks = {
  bill: [
    ...
    ["units-toggle", "ไม่มีเลขมิเตอร์ก็ได้", "ถ้าไม่มีเลขมิเตอร์ครั้งก่อน กดตรงนี้เพื่อกรอกจำนวนหน่วยที่ใช้เองได้เลย ไม่ต้องเดาหรือเว้นว่างไว้"],
...
function renderWalk() {
  ...
  else if (target === "units-toggle") el = $("toggleMeterMode");
